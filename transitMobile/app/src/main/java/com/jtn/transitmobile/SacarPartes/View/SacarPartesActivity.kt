...
class SacarPartesActivity : AppCompatActivity(),SacarPartesContract.View {
    ...
    fun initCard(){
        val layoutCard1Details: LinearLayout = findViewById(R.id.layoutCard1Details)

        val card1: CardView = findViewById(R.id.card1)


        card1.setOnClickListener {
            toggleDetailsVisibility(layoutCard1Details)
        }
    ...
    fun btnSacarParte(){
        ...
        btnParte.setOnClickListener{
            ...
            if (txtRut.text.isNotEmpty() && txtPatente.text.isNotEmpty() && txtNombreC.text.isNotEmpty() && txtApellidoP.text.isNotEmpty() && txtApellidoM.text.isNotEmpty() && txtDomicilioC.text.isNotEmpty()) {
                ...
                val newParte= Parte("${txtRut.text.toString()}","${txtNombreC.text.toString()}","${txtApellidoP.text.toString()}","${txtApellidoM.text.toString()}","${selectedOption.toString()}","${txtDomicilioC.text.toString()}","${fechaActual.toString()}","${nuevaFecha.toString()}","${horaActual.toString()}","${nombreCompleto.toString()}")
    ...
    private fun toggleDetailsVisibility(layout: LinearLayout) {
